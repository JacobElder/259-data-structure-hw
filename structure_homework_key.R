...
# Make Rank and Year into integer variables before binding them into rs_all
...
# The join failed because of differences in how the songs and artists names were written
...
# Read the file "top_25.csv" into a tibble called top25
...
# Merge in the data from rs_joined to top20 using left_join
...
# and add that as a new variable to top 20. It should be a factor
